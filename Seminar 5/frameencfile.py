...
while(True):
    ...
    if key== ord('c'):
       ...
       #All DC indices (starting with position 0,0 and then each N'th coefficient)
       #We use our codebook with range -2...1, hence we subtract -2 for DC to get this range:
