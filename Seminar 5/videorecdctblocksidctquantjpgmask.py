...
bits=0
quantstufe5=8.0/(2**bits-0.99) # Avoid div. by 0! 
#Fig.: 1 * 4 bits + 2 * 3 bits + 3 * 2bits + 4 * 1 bits for 64 pixels, so 0.3125 bits per pixel!

#Quantization levels in "mask", anti-diagonal have equal quantum levels:
M=np.zeros((8,8))
M[0,0]=quantstufe1
...
#Instead of our self-made quantization mask, we take the JPEG Mask,
#for nirmalized pixel values:
...
while(True):
    ...
    #Quantize:
    #print('Quantize with quantization mask:')
